...
| ADR | Decision | Status |
| --- | --- | --- |
| [0001](0001-read-only-privacy-boundary.md) | Read-only Gmail and metadata-only persistence boundary | Accepted |
| [0002](0002-resumable-idempotent-scans.md) | Page-boundary checkpoints and idempotent upserts | Accepted |
